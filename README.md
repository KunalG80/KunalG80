<!--
**KunalG80/KunalG80** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
🔗 [LinkedIn](https://www.linkedin.com/in/me-kunalgujar) • [HackerRank](https://www.hackerrank.com/profile/Kunal_Gujar)
...
I’m a **CDAC-certified software developer** with a background in **Electronics & Telecommunication Engineering** and hands-on experience in **backend development, automation, and system-level problem solving**.
...
- Debug **real-world systems** (software + hardware) under constraints
- Write **maintainable code**, not demo-only projects
